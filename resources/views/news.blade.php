                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade show active" id="tabs-1-1">
                        ...
                        <div class="nk-blog-post nk-blog-post-border-bottom">
                            ...
                            <div class="nk-post-date mt-10 mb-10">
                                <span class="fa fa-calendar"></span> Sep 5, 2020
                        ...
                        <div class="nk-blog-post nk-blog-post-border-bottom">
                            <div class="row vertical-gap">
                                ...
                                <div class="col-lg-9 col-md-7">
                                    ...
                                    <div class="nk-post-date mt-10 mb-10">
                                        <span class="fa fa-calendar"></span> Jul 3, 2020
                        ...
                        <div class="nk-blog-post nk-blog-post-border-bottom">
                            <div class="row vertical-gap">
                                ...
                                <div class="col-lg-9 col-md-7">
                                    <h2 class="nk-post-title h4"><a href="blog-article.html">He made his passenger captain of one</a></h2>
                                    <div class="nk-post-date mt-10 mb-10">
                                        <span class="fa fa-calendar"></span> Jul 23, 2020
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="tabs-1-3">
                        ...
                        <div class="nk-blog-post nk-blog-post-border-bottom">
                            ...
                            <div class="nk-post-date mt-10 mb-10">
                                <span class="fa fa-calendar"></span> Aug 27, 2020
                                <span class="fa fa-comments"></span> <a href="#">7 comments</a>
                            </div>
                            <div class="nk-post-text">
                        ...
                        <div class="nk-blog-post nk-blog-post-border-bottom">
                            <div class="row vertical-gap">
                                ...
                                <div class="col-lg-9 col-md-7">
                                    ...
                                    <div class="nk-post-date mt-10 mb-10">
                                        <span class="fa fa-calendar"></span> Aug 14, 2020
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            ...
                            <div class="nk-post-date float-right"><span class="fa fa-calendar"></span> Sep 18, 2020</div>
                        </div>
                        <!-- END: Post -->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            ...
                            <div class="nk-gap"></div>
                            <a href="blog-article.html" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">Read More</a>
                            <div class="nk-post-date float-right"><span class="fa fa-calendar"></span> Sep 5, 2020</div>
                        </div>
                        <!-- END: Post -->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            ...
                            <div class="nk-gap"></div>
                            <a href="blog-article.html" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">Read More</a>
                            <div class="nk-post-date float-right"><span class="fa fa-calendar"></span> Aug 27, 2020</div>
                        </div>
                        <!-- END: Post -->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            ...
                            <div class="nk-gap"></div>
                            <a href="blog-article.html" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">Read More</a>
                            <div class="nk-post-date float-right"><span class="fa fa-calendar"></span> Aug 14, 2020</div>
                        </div>
                        <!-- END: Post -->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            ...
                            <div class="nk-gap"></div>
                            <a href="blog-article.html" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">Read More</a>
                            <div class="nk-post-date float-right"><span class="fa fa-calendar"></span> Jul 23, 2020</div>
                        </div>
                        <!-- END: Post -->
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            ...
                            <div class="nk-gap"></div>
                            <a href="blog-article.html" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">Read More</a>
                            <div class="nk-post-date float-right"><span class="fa fa-calendar"></span> Jul 3, 2020</div>
                        </div>
                        <!-- END: Post -->
                    </div>
